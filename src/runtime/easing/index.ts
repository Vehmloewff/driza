/*
	From https://github.com/sveltejs/svelte/blob/master/src/runtime/easing/index.ts
	Distributed under the MIT License https://github.com/sveltejs/svelte/blob/master/LICENSE
*/
